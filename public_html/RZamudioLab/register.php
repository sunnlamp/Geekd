...
if(isset($_POST['submitted'])) {
  ...
  if(empty($errors)) { // If everything is ok.
    ...
    $r = @mysqli_query ($abc, $q); // Run the query
    if($r) { // If it ran OK.
      // Print a MessageFormatter
      echo '<h1>Thank you!</h1>
      <p>You are now registerd. In Chapter 11 toy will actually be able to log in!
      </p><p><br /></p>';
...
?>
<h1>Register</h1>
<p>First Name: <input type=”text” name=”first_name” size=”15” maxlength=”20” value=”
<?php if (isset($_POST[‘first_name’])) echo $_POST[‘first_name’]; ?>” /></p>
<p>Last Name: <input type=”text” name=”last_name” size=”15” maxlength=”40” value=”
