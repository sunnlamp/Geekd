...
if (isset($_POST['submitted'])) {
	...
	if (empty($errors)) { // If everything's OK.
		...
		// Make the query:
		$q = "INSERT INTO usersC (first_name, last_name, email, pass, registration_date) VALUES ('$fn', '$ln', '$e', SHA1('$p'), NOW() )";		
		$r = @mysqli_query ($dbc, $q); // Run the query.
		if ($r) { // If it ran OK.
		
			// Print a message:
			echo '<h1>Thank you!</h1>
		<p>You are now registered. This is just a mockup to demonstrate PHP/MySQL integration!!</p><p><br /></p>';	
